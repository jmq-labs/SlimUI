...
<div id="MENU_CONTAINER">	 
	...
	<label class="INPUT_LABEL" >Ordenar por: </label>
		...
		<label class="INPUT_LABEL" >De: </label>
		<select id="DEPT" class="_COMBO_BOX" style="margin-left:10px" onchange="showTicketAll()" >						
			<option>Todos</option>
			<option><?php echo $_SESSION['user_department']; ?></option>
		</select>
...
<hr />
	...
	<input id="TABBT5" class="TAB _INPUT_BUTTON CORNER_TOP" type="button" value="Eventos"  />	
	<input id="TABBT4" class="TAB _INPUT_BUTTON CORNER_TOP" type="button" value="Proyectos"  />	
	...
	<div class="TABFRAME">
  	   <div id="SEARCH_DIV">
    	   <label class="INPUT_LABEL" >Busqueda: </label>
      	   <input id="SEARCH_INPUT" type="text" class="INPUT_TEXT" />
		   <hr />		   
	   </div>
